<x-app-layout title="Dashboard">
    ...
    <div class="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4">
        @foreach ([
            ...
            ['label' => 'Pending Payments', 'value' => $stats['pending_payment'], 'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 9v-1'],
        ] as $card)
            <div class="card p-4">
    ...
    @if ($stats['pending_payment'] > 0)
        <div class="mt-6 rounded-xl bg-amber-50 border border-amber-100 px-5 py-4 flex items-center justify-between gap-4">
            ...
            <a href="{{ route('account.bookings') }}" class="btn-accent !py-1.5 !px-3 text-xs shrink-0">Review</a>
        </div>
    @endif

    @if ($upcomingBooking)
        <div class="mt-8">
            <h2 class="text-lg font-bold text-ink mb-3">Your Next Trip</h2>
    ...
    <div class="mt-8">
        <div class="flex items-center justify-between mb-3">
            ...
            <a href="{{ route('account.bookings') }}" class="text-sm font-medium text-primary hover:underline">View all</a>
        </div>
