...
<body class="min-h-screen bg-slate-50 text-slate-800 flex items-center justify-center p-6 font-sans">
    ...
    <div
        ...
        <div
            class="inline-flex items-center justify-center w-16 h-16 bg-rose-50 text-rose-600 rounded-2xl mb-6 font-bold text-xl">
        ...
        <p class="mt-3 text-slate-500 text-sm sm:text-base leading-relaxed">
            Maaf, terjadi kendala teknis pada sistem kami. Tim kami sedang berupaya untuk memperbaikinya secepat
            mungkin.
        </p>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
            <button onclick="window.location.reload()"
                class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white font-medium text-sm rounded-lg transition-colors shadow-sm">
